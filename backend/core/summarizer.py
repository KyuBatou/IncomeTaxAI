...
class SummarizerSummarizeView(APIView):
    ...
    def post(self, request):
        try:
            ...
            if response.status_code == 200:
                ...
                message.ai_answer = api_response_json.get("content", "No answer returned from the API.")
                ...
                return JsonResponse({
                    "success": True,
                    "answer": api_response_json.get("content", "No answer returned from the API."),
